          ...
          <table className="w-full min-w-[900px]">
            <thead>
              <tr className="border-b border-gray-800">
                <th className="text-left px-3 sm:px-6 py-3 text-xs sm:text-sm font-medium text-gray-400">
                  Name
                </th>
                <th className="text-left px-3 sm:px-6 py-3 text-xs sm:text-sm font-medium text-gray-400">
                  Email
            ...
            <tbody>
              {users.map((user) => (
                ...
                >
                  ...
                  <td className="px-3 sm:px-6 py-3 text-xs sm:text-sm text-gray-300 capitalize">
                  ...
                  <td className="px-3 sm:px-6 py-3 text-xs sm:text-sm text-gray-300">
                    {user.school}
                  </td>
                  <td className="px-3 sm:px-6 py-3 text-xs sm:text-sm text-gray-300">
                    {user.streak}
